...
var DownloadContentVersion_1 = require("./engine/DownloadContentVersion");
var UploadContentVersion_1 = require("./engine/UploadContentVersion");
var AppDocument = /** @class */ (function () {
    ...
    AppDocument.prototype.init = function () {
    ...
    AppDocument.prototype.getNextMappingRecord = function () {
        return this.mappingList.findIndex(function (item) { return !item.finished; });
    };
    AppDocument.prototype.updateMappingRecord = function (index, data) {
        Object.assign(this.mappingList[index], data);
    };
    AppDocument.prototype.startProcess = function () {
        return __awaiter(this, void 0, void 0, function () {
            var mappingIndex, _a, OriginParentId, TargetParentId, msgLinhas, documents, documentsPath, downloadEngine;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, SalesforceRepository_1.getOriginContentDocumentLinkRecords(this.originOrgInstance, OriginParentId)];
                    case 1:
                        documents = _b.sent();
                        ...
                        documentsPath = path_1.default.resolve(this.tempPath, OriginParentId, 'downloads', 'documents');
                        console.log('');
                        console.log('==> STARTING DOWNLOAD');
                        downloadEngine = new DownloadContentVersion_1.DownloadContentVersion(documents, documentsPath, this.originOrgInstance);
                        downloadEngine.subscribe(function (downloadState) {
                            console.log('');
                            // console.log(downloadState)
                            console.log('==> STARTING UPLOAD');
                            var uploadEngine = new UploadContentVersion_1.UploadContentVersion(documentsPath, _this.targetOrgInstance, TargetParentId);
    ...
    AppDocument.prototype.finishProcess = function () {
        console.log('');
        console.log('==============================================');
